...
export const Solution: React.FC = () => {
  return (
    <section id="solution" className="relative py-24 bg-white dark:bg-[#0c0c0e] transition-colors duration-300 overflow-visible">
      {/* Background Atmospheric Gradients */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-terracotta/5 dark:bg-terracotta/[0.07] blur-[150px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-artevrika/5 dark:bg-artevrika/[0.07] blur-[150px] rounded-full" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40%] h-[40%] bg-zinc-500/5 dark:bg-white/[0.02] blur-[120px] rounded-full" />
      </div>
      ...
      <div className="container-fluid relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-14 md:gap-y-16">
              {GRID_ITEMS.map((item, i) => (
                <div 
                  key={i} 
                  className="relative px-8 pb-8 pt-14 rounded-[2.5rem] bg-white/40 dark:bg-zinc-900/40 border border-zinc-200 dark:border-white/5 backdrop-blur-sm hover:ring-[6px] hover:ring-terracotta/10 transition-all duration-300 group shadow-lg flex flex-col gap-5 overflow-visible"
                >
                  {/* Floating Icon */}
                  ...
                  <h4 className="text-[clamp(13px,1.5vw,16px)] font-heading font-bold tracking-tight dark:text-white text-zinc-900 uppercase leading-tight break-words hyphens-auto">
                    {item.title}
                  </h4>
            ...
            <div 
              className="p-8 md:p-10 rounded-[3rem] bg-white/40 dark:bg-[#0e1210]/60 border border-zinc-200 dark:border-artevrika/20 backdrop-blur-md hover:ring-[6px] hover:ring-artevrika/10 transition-all duration-300 group shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center gap-8"
            >
          ...
          <div className="lg:col-span-5 w-full rounded-[2.5rem] md:rounded-[3.5rem] border border-zinc-200 dark:border-white/5 overflow-hidden bg-white/40 dark:bg-[#08080a]/60 backdrop-blur-xl p-2 md:p-3 shadow-2xl transition-all duration-300 hover:ring-[6px] hover:ring-terracotta/10">
              ...
              <table className="w-full text-left border-collapse min-w-[320px]">
                <thead>
                  <tr className="bg-zinc-50/50 dark:bg-black/20 font-heading">
                    <th className="p-4 md:p-7 text-[8px] md:text-[9px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.1em] md:tracking-[0.25em] leading-none">Этап</th>
                    <th className="p-4 md:p-7 text-[8px] md:text-[9px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.1em] md:tracking-[0.25em] leading-none text-center">Без AI</th>
                    <th className="p-4 md:p-7 text-[8px] md:text-[9px] font-black uppercase tracking-[0.1em] md:tracking-[0.25em] text-terracotta leading-tight text-center bg-terracotta/[0.03]">
                ...
                <tbody className="font-sans">
                  {[
                    ...
                    <tr key={i} className="border-t border-zinc-100 dark:border-zinc-800/50 group transition-colors">
                      <td className="p-4 md:p-7 font-bold dark:text-white text-zinc-800 text-[11px] md:text-[13px] leading-tight">{row.stage}</td>
                      <td className="p-4 md:p-7 font-medium text-zinc-500 dark:text-zinc-400 text-[11px] md:text-[13px] text-center">{row.traditional}</td>
                      <td className="p-4 md:p-7 font-bold text-terracotta text-[11px] md:text-[13px] text-center bg-terracotta/[0.03] group-hover:bg-terracotta/[0.06] transition-colors">{row.ai}</td>
                    </tr>
                  ))}
                  {/* Summary Row */}
                  <tr className="bg-terracotta/[0.06] dark:bg-[#150f0f] border-t-2 border-terracotta/20">
                    ...
                    <td className="p-5 md:p-8 font-sans font-bold text-zinc-500 dark:text-zinc-400 text-[12px] md:text-[14px] text-center">20–28 дн.</td>
                    <td className="p-5 md:p-8 font-heading font-black text-terracotta text-[18px] md:text-[24px] tracking-tighter text-center">2–3 дня</td>
                  </tr>
                </tbody>
              </table>
            </div>
